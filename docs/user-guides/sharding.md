...
<details markdown="1">
  <summary markdown="1">
    ...
    <ul>
      <li>[Sharding](https://docs.kuadrant.io/authorino/docs/architecture#sharding)</li>
      <li>Identity verification & authentication → [API key](https://docs.kuadrant.io/authorino/docs/features#api-key-authenticationapikey)</li>
    </ul>
  </summary>
